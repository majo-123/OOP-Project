...
public class manageProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inventoryID.setBackground(new java.awt.Color(0, 0, 0));
        inventoryID.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(inventoryID, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(inventoryID, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
...
// Assuming you have a method to get the ID from a text field or similar component
String idString = inventoryID.getText(); // Replace with your actual id input component
int id = Integer.parseInt(idString); // Convert the string id to an integer
...
String idString = inventoryID.getText(); // Get the item ID
int id = Integer.parseInt(idString); // Convert the string ID to an integer

// Assuming you have JTextFields or similar components for name, price, quantity, and category
String newName = inventoryName.getText(); // Get the new name
String newPriceStr = inventoryPrice.getText(); // Get the new price
int newQuantity = Integer.parseInt(inventoryQuantity.getText()); // Get the new quantity
String newCategory = inventoryCategory.getText(); // Get the new category
...
try {
    ...
    checkPstmt.setString(1, newName); // Set the new name to check
    checkPstmt.setInt(2, id); // Exclude the item being updated
    ...
    // SQL query to update data in inventoryTable using ID
    ...
    pstmt.setDouble(2, newPrice); // Set new price
    pstmt.setInt(3, newQuantity); // Set new quantity
    pstmt.setString(4, newCategory); // Set new category
    pstmt.setInt(5, id); // Use setInt for the ID
    ...
    if (rowsAffected > 0) {
        ...
        inventoryQuantity.setText("");
        inventoryPrice.setText("");
        inventoryCategory.setText("");// Call refresh to update the display
...
try {
    ...
    // You can call this function whenever you need to load data, 
    // like after adding a new item or when the form is opened.
